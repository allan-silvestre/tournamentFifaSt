...
public class Games extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visitante_jogos);
        ...
        tabelaId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Games.this, com.agsistemas.torneiofifast.screens.visitor.Classification.class);
        ...
        historicoId.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Games.this, Historic.class);
                startActivity(intent);
            }
        });
